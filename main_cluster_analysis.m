...
pipe_name ='IIR BP 1 Hz Pass Edge - Lower Order - Notch Filters - VEOG';
...
pipeline = create_pipeline_structure(data_dir,pipe_name,srate);
...
pipeline = get_clusters(pipeline,labels_of_each_cluster,labels_of_channels_in_each_cluster,'veog');
...
%%
single_trial_cluster_stats(pipeline,2)