...
function vers = eegplugin_amica(fig, trystrs, catchstrs)
    ...
    uimenu( submenu, 'Label', 'Plot Model Probabilities'  , 'CallBack', complotmodelprob);
    uimenu( submenu, 'Label', 'Plot 2-D AMICA comp. maps'  , 'CallBack', comtopohistplot);
    ...
    uimenu( submenu, 'Label', 'Plot pairwise mutual info. between IC''s'  , 'CallBack', complotmodelPMI);
    uimenu( submenu, 'Label', 'Select data using model probabilities'  , 'CallBack', comselectmodel);
